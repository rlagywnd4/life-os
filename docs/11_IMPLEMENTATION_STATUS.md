...
| Native App V1                             | Partial | iPhone·Mac 공용 SwiftUI 기반과 Supabase 로그인, `UNREVIEWED` Inbox 읽기 흐름을 구현함. 로컬 URL은 Xcode 설정용 표기 형식이 필요하며, 실제 계정 로그인 확인, Inbox 추가·수정·삭제, 검색, 실시간 갱신은 아직 남아 있음. |
